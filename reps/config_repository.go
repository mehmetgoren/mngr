...
func (r *ConfigRepository) RestoreConfig() (*models.Config, error) {
	objJson := `{"device":{"device_name":"dev","device_type":0},"jetson":{"model_name":"ssd-mobilenet-v2"},"torch":{"model_name":"ultralytics/yolov5","model_name_specific":"yolov5x6"},"tensorflow":{"model_name":"efficientdet/lite4/detection","cache_folder":"/mnt/sdc1/test_projects/tf_cache"},"once_detector":{"imagehash_threshold":3,"psnr_threshold":0.2,"ssim_threshold":0.2},"source_reader":{"resize_img":false,"buffer_size":2,"max_retry":150,"max_retry_in":6},"general":{"root_folder_path":"/mnt/sda1","heartbeat_interval":30},"db":{"type":1,"connection_string":"mongodb://localhost:27017"},"ffmpeg":{"use_double_quotes_for_path":false,"max_operation_retry_count":10000000,"rtmp_server_init_interval":3,"watch_dog_interval":23,"watch_dog_failed_wait_interval":3,"start_task_wait_for_interval":1,"record_concat_limit":1,"record_video_file_indexer_interval":60},"ai":{"overlay":true,"video_clip_duration":10,"face_recog_mtcnn_threshold":0.86,"face_recog_prob_threshold":0.95,"plate_recog_instance_count":2},"ui":{"gs_width":4,"gs_height":3,"booster_interval":0.3,"seek_to_live_edge_internal":30},"jobs":{"mac_ip_matching_enabled":false,"mac_ip_matching_interval":0},"deep_stack":{"server_url":"","server_port":0,"performance_mode":0,"api_key":"","od_enabled":false,"od_threshold":0,"fr_enabled":false,"fr_threshold":0,"docker_type":0},"archive":{"limit_percent":95,"action_type":0,"move_location":""}}`
