...
func (r *ConfigRepository) RestoreConfig() (*models.Config, error) {
	objJson := `{"ai":{"face_recog_mtcnn_threshold":0.86,"face_recog_prob_threshold":0.95,"overlay":true,"plate_recog_instance_count":2,"video_clip_duration":10},"db":{"connection_string":"mongodb://localhost:27017","type":1},"device":{"device_name":"dev","device_type":0},"ffmpeg":{"max_operation_retry_count":10000000,"record_concat_limit":1,"record_video_file_indexer_interval":60,"rtmp_server_init_interval":3.0,"start_task_wait_for_interval":1.0,"use_double_quotes_for_path":false,"watch_dog_failed_wait_interval":3.0,"watch_dog_interval":23},"general":{"heartbeat_interval":30,"root_folder_path":"/mnt/sde1"},"jetson":{"model_name":"ssd-mobilenet-v2"},"once_detector":{"imagehash_threshold":3,"psnr_threshold":0.2,"ssim_threshold":0.2},"source_reader":{"buffer_size":2,"max_retry":150,"max_retry_in":6,"resize_img":false},"tensorflow":{"cache_folder":"/mnt/sdc1/test_projects/tf_cache","model_name":"efficientdet/lite4/detection"},"torch":{"model_name":"ultralytics/yolov5","model_name_specific":"yolov5x6"},"ui":{"booster_interval":0.3,"gs_height":3,"gs_width":4,"seek_to_live_edge_internal":30}}`
