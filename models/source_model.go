...
type SourceModel struct {
	...
	InputFrameRate      float32 `json:"input_frame_rate" redis:"input_frame_rate"`
	...
	StreamFrameRate       float32 `json:"stream_frame_rate" redis:"stream_frame_rate"`
	...
	RecordFrameRate       float32 `json:"record_frame_rate" redis:"record_frame_rate"`
